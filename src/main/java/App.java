...
public class App {
    public static void main(String[] args) throws IOException {
        ...
        EventDrivenMolecularDynamics edmd = new EventDrivenMolecularDynamics(numberOfParticles, 0.24, 0.09, slitWidth, 0.01, 1.0, 0.001, threshold,equilibriumIterations, staticOutputFileName,dynamicOutputFileName, summaryFileName);
        edmd.run();
    }
}
