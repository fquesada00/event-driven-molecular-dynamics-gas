...
public class ParticleXWallCollisionEvent extends ParticleWallCollisionEvent {
    public ParticleXWallCollisionEvent(double time, Particle particle) {
        super(time, particle);
    }
